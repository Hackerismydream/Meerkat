...
**19 progressive steps** that teach you how to build an minimal version of OpenClaw. Each step includes:
...
### Phase 5: Business Capstone (Step 18)
Connect the runtime to a realistic business event stream and evaluate agent behavior.

- [**18-business-capstone-meerkat**](./18-business-capstone-meerkat/) - Live operations anomaly handling with Owncast, FastAPI, multi-agent dispatch, risk guardrails, trace, and eval.
